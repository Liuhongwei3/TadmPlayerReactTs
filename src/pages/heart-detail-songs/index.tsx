...
import { Avatar, Table, Image, Tooltip } from "antd";
...
const HeartDetailSongs: React.FC = observer(() => {
    ...
    return (
        <StyledWrapper>
            <div style={{ width: "100%" }}>
                <Tooltip title="歌单名">
                    <StyledTag color="magenta">心动歌单</StyledTag>
                </Tooltip>
                ...
                <Table<ISong>
                    ...
                    scroll={{ x: true }}
                    columns={columns}
                    dataSource={store.curHeartPlaylists.map((item, index) => {
                        return { ...item, index: index + 1 };
                    })}
                    pagination={{
                        showQuickJumper: true,
                        total: store.curHeartPlaylists.length,
                        current: page,
                        pageSize,
...
export default HeartDetailSongs;
